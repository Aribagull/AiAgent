...
export default function HomePage() {
  ...
  const processSteps = [
    {
      ...
      description: "We begin by understanding your goals and pain points. Many companies feel overwhelmed by manual tasks and costly, complex tools we’re here to change that.",
      step: "01",
    },
    {
      icon: <Bot className="h-8 w-8" />,
      title: "Development & Selection",
      description: "Choose from our ready-to-use AI apps, request a custom ERP/CRM, or explore innovative options like our AI Voice Agents, Automations system or TV-in-a-Card campaigns.",
      step: "02",
    },
    {
      icon: <Wrench className="h-8 w-8" />,
      title: "Integration & Testing",
      description: "We help you execute your business strategy with our new solution, ensuring seamless automation.",
      step: "03",
    },
    {
      icon: <Rocket className="h-8 w-8" />,
      title: "Launch & Measure",
      description: "Once live, well help you track ROI through our intuitive dashboard. See time savings and revenue gains in realtime.",
      step: "04",
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold neon-text tracking-tight">Aibotsautomations</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="fade-in-scroll">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-4xl mx-auto text-pretty leading-relaxed">
              We make AI and marketing simple and accessible, helping anyone succeed regardless of experience. Our tools are designed to make technology easier to use and more effective. Technology should make life easier, and we are committed to making that a reality.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-10">
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-foreground/90">Save time with automated responses</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span className="text-foreground/90">Enhance customer satisfaction</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span className="text-foreground/90">Reduce support team workload</span>
                  </li>
                </ul>
              </CardContent>
            </UiCard>
            ...
            <UiCard className="fade-in-scroll neon-glow hover:scale-105 transition-all duration-500 glass-effect">
              <CardHeader className="pb-6">
                ...
                <CardDescription className="text-lg leading-relaxed">
                 We enable smarter decision making, by using the predictive analytics to forecast trends, customer behavior, and business outcomes. 
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span className="text-foreground/90">Identify future opportunities</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span className="text-foreground/90">minimize risks with data - driven insights</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0" />
                    <span className="text-foreground/90">⁠improve business efficiency</span>
                  </li>
                </ul>
              </CardContent>
            </UiCard>
            ...
            <UiCard className="fade-in-scroll neon-glow hover:scale-105 transition-all duration-500 glass-effect">
              <CardHeader className="pb-6">
                ...
                <CardDescription className="text-lg leading-relaxed">
                  Our Computer vision tool analyzes and interprets images and videos, enabling automation, quality control, and enhanced security.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 fade-in-scroll">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              For growing businesses; includes multiple AI apps, ERP modules & access to our TV-in-a-Card package.
            </p>
          </div>
  ...
  <div className="max-w-4xl mx-auto text-center fade-in-scroll">
    ...
    <p className="text-xl text-muted-foreground mb-8">
      Biggest manual task to business pain points and let us demonstrate a tailored solution.
    </p>
  ...
  <textarea 
    ...
    className="p-3 rounded-lg w-full bg-white/10 text-white resize-none"
  ></textarea>
  <Button 
    type="submit" 
